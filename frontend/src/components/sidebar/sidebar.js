...
const Sidebar = () => {
    ...
    <Drawer variant="permanent" sx={{"& .MuiPaper-root": { borderRight: "none", } }}>
        <List style={{width: '250px', backgroundColor: 'rgba(42, 67, 97, 1)', height: '100%', overflowY: 'scroll'}}>
            ...
            {/* Dashboard */}
            <ListItem component={Link} to="/dashboard" style={{backgroundColor: "white", borderRadius: '12px', marginBottom: '5px', marginLeft: '5px', width: '240px', color: isHoveredD ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredD(true)}} onMouseOut={() => {setIsHoveredD(false)}}>
                <ListItemIcon>
                    <AiIcons.AiFillHome style={{color: isHoveredD ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredD(true)}} onMouseOut={() => {setIsHoveredD(false)}}/>
                </ListItemIcon>
                <ListItemText primary="Dashboard" />
            </ListItem>
            
            {/* Estatisticas */}
            <ListItem onClick={handleClickE} style={{backgroundColor: "white", borderRadius: '12px', marginBottom: '5px', marginLeft: '5px', width: '240px', color: isHoveredE ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredE(true)}} onMouseOut={() => {setIsHoveredE(false)}} >
                <ListItemIcon>
            ...
            <Collapse in={openE} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                    <ListItem component={Link} to="/estatisticas/utilizadores" style={{backgroundColor: "white", borderRadius: '12px', marginBottom: '5px', marginLeft: '30px', width: '215px', color: isHoveredEU ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredEU(true)}} onMouseOut={() => {setIsHoveredEU(false)}}>
                        <ListItemIcon>
                            <IoIcons.IoIosPaper style={{color: isHoveredEU ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredEU(true)}} onMouseOut={() => {setIsHoveredEU(false)}} />
                        </ListItemIcon>
                        <ListItemText primary="Utilizadores" />
                    </ListItem>
                    <ListItem component={Link} to="/estatisticas/denuncias" style={{backgroundColor: "white", borderRadius: '12px', marginBottom: '5px', marginLeft: '30px', width: '215px', color: isHoveredED ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredED(true)}} onMouseOut={() => {setIsHoveredED(false)}} >
                        <ListItemIcon>
                            <IoIcons.IoIosPaper style={{color: isHoveredED ? 'rgba(77, 156, 250, 1)' : 'black'}} onMouseOver={() => {setIsHoveredED(true)}} onMouseOut={() => {setIsHoveredED(false)}}/>
                        </ListItemIcon>
